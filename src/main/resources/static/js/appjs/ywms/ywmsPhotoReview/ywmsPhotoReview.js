...

							{
								...
								title : '创建时间'
									...
									formatter : function(value, row, index) {
										...
										var e = '<a class="btn btn-warning btn-sm" href="#" title="不通过"  mce_href="#" onclick="no(\''	+ row.id+ '\',\''+ row.userid+'\')"><i class="fa fa-remove"></i></a> ';
										return d+e ;
									}
								} ]
					});
